...
end_training_image = '/images/AutoTrainEnd.png'
strengthen = '/images/strengthen.png'
orbIcon = '/images/orb.png'
JewelIcon = '/images/jewel.png'
battleButton = '/images/battle.png'
maxLifeButton = '/images/maxLife.png'
OKButton = '/images/OK.png'
sortieButton = '/images/sortie.png'
formerTeamButton = '/images/formerteam.png'
homeButton = '/images/homeButton.png'
turnEndButton = '/images/turnEnd.png'
battleResult = '/images/battleResult.png'
againButton = '/images/again.png'
yameru = '/images/yameru.png'
toki = '/images/toki.png'
autoRun = '/images/autoRun.png'
endGame = '/images/endGame.png'
skipButton = '/images/skip.png'
notEnoughLife = '/images/notEnoughLife.png'
useLifeStone = '/images/useLifeStone.png'
dailyFree = '/images/dailyFree.png'
dailyGachaConfirm = '/images/dailyGachaConfirm.png'
okButtonDaily = '/images/okButtonDaily.png'
missionButton = '/images/missionButton.png'
takeRewardButton = '/images/takeReward.png'
backButton = '/images/backButton.png'
weeklyButton = '/images/weeklyButton.png'
takeRewardDisabled = '/images/takeRewardDisabled.png'
maxLifeButton2 = '/images/maxLife2.png'
arenaButton = '/images/arenaButton.png'
skipDialog = '/images/skipDialog.png'
arenaYameru = '/images/arenaYameru.png'
arenaBack = '/images/arenaBack.png'
autoOn = '/images/autoOn.png'
arenaForm = '/images/arenaForm.png'
dialogAutoOff = '/images/dialogAutoOff.png'
menu = '/images/menu.png'
terminate = '/images/terminate.png'
resourceLife = '/images/resourceLife.png'
orbBossTicket = '/images/orbBossTicket.png'
jewelTicket = '/images/jewelTicket.png'
